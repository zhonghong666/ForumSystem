...
public final class GraphicHelper {
    ...
    public static void main(String[] args) throws Exception {
        String x = GraphicHelper.create(4, true, 180, 50, new FileOutputStream("D:/character.jpg"), 30);
        System.out.println(x);
        String s = GraphicHelper.create(6, false, 180, 50, new FileOutputStream("D:/letter.jpg"), 30);
